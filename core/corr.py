...
class CorrBlock1D:
    def __init__(self, fmap1, fmap2, num_levels=4, radius=4):
        ...
        # Dimension is 1: is obtained by average summation
        batch, h1, w1, dim, w2 = corr.shape
    ...
    def __call__(self, coords):
        '''
        coords 2 is the right coordinate
        '''
        r = self.radius # Local Searching range
        coords = coords[:, :1].permute(0, 2, 3, 1)
        # Last dimension is the searching range
        batch, h1, w1, _ = coords.shape
