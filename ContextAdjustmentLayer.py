...
class ContextAdjustmentLayer(nn.Module):
    ...
    design loosely follows https://github.com/JiahuiYu/wdsr_ntire2018
    """
...
def build_context_adjustment_layer(options='cal'):
    if options== 'cal':
        return ContextAdjustmentLayer(num_blocks=8, feature_dim=16,
                                      expansion=4)
    elif options == 'none':
        return None
    else:
