...
class Concated_Head(nn.Module):
    def __init__(self,select_res='1/8'):
        ...
        self.downsample = nn.Sequential(
            nn.Conv2d(1440,256,3,1,1,bias=False),
            nn.BatchNorm2d(256),
            nn.GELU()
        )
...
if __name__=="__main__":
    ...
    swin_t_ednet = Swin_T_EDNet(max_disp=192,res_type='attention',squeezed_volume=True).cuda()
