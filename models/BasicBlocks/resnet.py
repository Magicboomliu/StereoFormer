...
import sys
sys.path.append("../..")
from deform.modules.modulated_deform_conv import ModulatedDeformConv,ModulatedDeformConvPack
...
class DeformBlock(nn.Module):
    def __init__(self, n_in, n_out, kernel_size=3, stride = 1):
        ...
        self.bn1 = nn.BatchNorm2d(n_out)
        self.relu = nn.ReLU(inplace = True)
        self.conv2 = ModulatedDeformConvPack(n_out,n_out,kernel_size=3,stride=1,padding=1)
        self.bn2 = nn.BatchNorm2d(n_out)
