...
from models.LocalCostVolume.Attempts.variance_based_method import Variance_Based_Local_Cost_Volume
...
class LowCNN(nn.Module):
    def __init__(self, max_disp=192,cost_volume_type='correlation',
        ...
        if self.adaptive_refinement:
            self.local_cost_volume = Variance_Based_Local_Cost_Volume(garma=2,sample_points=20)
