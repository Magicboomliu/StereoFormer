...
from models.LocalCostVolume.Attempts.pure_learning_method_w_super import PureLearningLocalCostVolume
...
class LowCNN(nn.Module):
    ...
    def forward(self,left,right,is_training=True):
        ...
        if self.adaptive_refinement:
            ...
            new_disp,lower_bound,upper_bound= self.local_cost_volume(final_cost,low_scale_disp3,left,right,True)
        ...
        if self.adaptive_refinement:
            return [pr0_0,pr0_1],[lower_bound,upper_bound],low_scale_disp3
...
if __name__=="__main__":
    ...
    if not use_adaptive_refinement:
        ...
        output_list, bounds, disp3 = lowCNN(left_image,right_image,True)
        print(output_list[0].shape)
        print(output_list[1].shape)
        print(bounds[0].shape)
        print(bounds[1].shape)
        print(disp3.shape)
