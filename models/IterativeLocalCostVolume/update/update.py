...
class BasicMotionEncoder_LZH(nn.Module):
    def __init__(self,
                 corr_levels,
                 corr_radius
                 ):
        super(BasicMotionEncoder_LZH,self).__init__()
...
class BasicMultiUpdateBlock_LZH(nn.Module):
    def __init__(self,corr_levels,
                 corr_radius,
                 n_gru_layers,
                 n_downsample,
                 hidden_dims=[]):
        super(BasicMultiUpdateBlock_LZH,self).__init__()
        
        self.n_gru_layers = n_gru_layers
        self.n_downsample = n_downsample
        self.encoder = BasicMotionEncoder_LZH(corr_levels=corr_levels,corr_radius=corr_radius)
