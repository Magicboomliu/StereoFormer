...
from models.GMA_Stereo.disparity_update import CMAUpdateBlock,BasicUpdateBlock
...
class RaftStereo(nn.Module):
    def __init__(self,
        ...
        self.update_block = BasicUpdateBlock(hidden_dim=128,cost_volume_dimension=self.num_levels*(2*self.radius+1))
